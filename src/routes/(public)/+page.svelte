		...
		<section class="col-span-4">
			<div class="section_title my-8">
				...
				<div class="font-semibold text-sky-700">
					<a class="mx-auto flex w-max" href="#">
			...
			<div class="grid md:grid-cols-3 md:grid-rows-4 xl:grid-rows-5 gap-2">
				<div class=" md:row-span-4 xl:row-span-5 md:col-span-2">
					...
					<a href="#">
						<h2 class="text-xl font-semibold uppercase hover:text-sky-900">lorem impum dulur</h2>
					</a>
				</div>
				<div class=" flex gap-2">
					...
					<div class="w-3/4">
						...
						<a href="#">
							<h2 class="text-lg font-semibold uppercase hover:text-sky-900">lorem impum dulur</h2>
						</a>
					</div>
				</div>
			</div>
